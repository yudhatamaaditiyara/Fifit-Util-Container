...
class Container
{
  ...
  get(name){
    if (!this.isExists(name)) {
      throw new IllegalArgumentError('The service "' + String(name) + '" not found');
    }
  ...
  set(name, service){
    if (!(service instanceof Service)) {
      throw new IllegalArgumentError('The service must be instance of Service');
    }
    if (this.isReadonly(name)) {
      throw new IllegalArgumentError('The service "' + String(name) +'" cannot be overridden');
    }
    Object.defineProperty(this._services, name, {
      value: service, configurable: !service.readonly, enumerable: true, writable: !service.readonly
    });
    return this;
  }
